...
0x02. AirBnB clone - MySQL is a complete RESTful web application, integrating file and
...
0x02. AirBnB clone - MySQL is still in active development, with complete functionality set to
...
<p align="center">
  <img src="https://github.com/Ahortu90/AirBnB_clone_v2/blob/master/assets/hbnb_stack.png"
	    alt="AirBnB_clone-MySQL stack">
</p>
...
https://github.com/Ahortu90/lyft_apprenticeship_application
...
(viewable [here](https://github.com/Ahortu90/AirBnB_clone)), I, together
...
ALX students from an older cohort. We then pair programmed
...
[version one](https://github.com/Ahortu90/AirBnB_clone) (the
...
The front-end of 0x02. AirBnB clone - MySQL was designed from scratch using HTML5/CSS3 pages
...
The 0x02. AirBnB clone - MySQL console supports the following commands:
...
Unittests for the 0x02. AirBnB clone - MySQL project are defined in the [tests](./tests)
